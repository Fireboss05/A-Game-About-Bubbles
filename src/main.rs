...
use crate::loading::systems::wait;
use crate::main_page::GameDataPlugin;

fn main() {
    let mut app = App::new();
    app.add_plugins(DefaultPlugins);
    app.init_state::<AppState>();
    app.add_plugins((MainPagePlugin, GamePlugin, GameDataPlugin, FeathersPlugins));
    app.insert_resource(UiTheme(create_light_theme()));
    app.add_systems(Startup, spawn_camera);
    app.add_systems(Startup, load_game_data);
